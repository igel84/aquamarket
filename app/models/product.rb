class Product < ActiveRecord::Base
  attr_accessible :product_id, :catalogue_section_id, :art, :name, :preview, :description, :price, :discount_price, :quantity, :product_translations_attributes, :product_images_attributes
